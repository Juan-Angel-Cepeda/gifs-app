...
export class GifsService {
  ...
  buscarGifs(query:string = ''){
    ...
    this.http.get<SearchGIFResponse>(`https://api.giphy.com/v1/gifs/search?api_key=cTkNCVXfXj0jdpgfM7H3QGQt9ZqtkWXg&q=${query}&limit=10&offset=0&rating=g&lang=en`)
    .subscribe((resp )=> {
